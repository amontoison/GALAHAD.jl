...
function spral_ssids_default_options(options)
    @ccall libgalahad_all.spral_ssids_default_options(options::Ptr{spral_ssids_options})::Cvoid
end
...
function spral_ssids_analyse_ptr32(check, n, order, ptr, row, val, akeep, options, inform)
    @ccall libgalahad_all.spral_ssids_analyse_ptr32(check::Bool, n::Cint, order::Ptr{Cint},
...
function spral_ssids_factor_ptr32(posdef, ptr, row, val, scale, akeep, fkeep, options,
                                  inform)
    @ccall libgalahad_all.spral_ssids_factor_ptr32(posdef::Bool, ptr::Ptr{Cint},
...
function spral_ssids_solve1(job, x1, akeep, fkeep, options, inform)
    @ccall libgalahad_all.spral_ssids_solve1(job::Cint, x1::Ptr{Float64},
...
function spral_ssids_solve(job, nrhs, x, ldx, akeep, fkeep, options, inform)
    @ccall libgalahad_all.spral_ssids_solve(job::Cint, nrhs::Cint, x::Ptr{Float64},
                                            ldx::Cint, akeep::Ptr{Cvoid}, fkeep::Ptr{Cvoid},
                                            options::Ptr{spral_ssids_options},
                                            inform::Ptr{spral_ssids_inform})::Cvoid
end

function spral_ssids_free_akeep(akeep)
    @ccall libgalahad_all.spral_ssids_free_akeep(akeep::Ptr{Ptr{Cvoid}})::Cint
end

function spral_ssids_free_fkeep(fkeep)
    @ccall libgalahad_all.spral_ssids_free_fkeep(fkeep::Ptr{Ptr{Cvoid}})::Cint
end

function spral_ssids_free(akeep, fkeep)
    @ccall libgalahad_all.spral_ssids_free(akeep::Ptr{Ptr{Cvoid}},
                                           fkeep::Ptr{Ptr{Cvoid}})::Cint
end

function spral_ssids_enquire_posdef(akeep, fkeep, options, inform, d)
    @ccall libgalahad_all.spral_ssids_enquire_posdef(akeep::Ptr{Cvoid}, fkeep::Ptr{Cvoid},
                                                     options::Ptr{spral_ssids_options},
...
function spral_ssids_enquire_indef(akeep, fkeep, options, inform, piv_order, d)
    @ccall libgalahad_all.spral_ssids_enquire_indef(akeep::Ptr{Cvoid}, fkeep::Ptr{Cvoid},
                                                    options::Ptr{spral_ssids_options},
                                                    inform::Ptr{spral_ssids_inform},
                                                    piv_order::Ptr{Cint},
                                                    d::Ptr{Float64})::Cvoid
...
function spral_ssids_alter(d, akeep, fkeep, options, inform)
    @ccall libgalahad_all.spral_ssids_alter(d::Ptr{Float64}, akeep::Ptr{Cvoid},
                                            fkeep::Ptr{Cvoid},
                                            options::Ptr{spral_ssids_options},
                                            inform::Ptr{spral_ssids_inform})::Cvoid
end
