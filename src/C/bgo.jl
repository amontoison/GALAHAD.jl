...
function bgo_initialize(data, control, status)
    @ccall libgalahad_all.bgo_initialize(data::Ptr{Ptr{Cvoid}},
                                         control::Ptr{bgo_control_type},
                                         status::Ptr{Cint})::Cvoid
end

function bgo_read_specfile(control, specfile)
    @ccall libgalahad_all.bgo_read_specfile(control::Ptr{bgo_control_type},
                                            specfile::Ptr{Cchar})::Cvoid
end

function bgo_import(control, data, status, n, x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
    @ccall libgalahad_all.bgo_import(control::Ptr{bgo_control_type}, data::Ptr{Ptr{Cvoid}},
...
function bgo_reset_control(control, data, status)
    @ccall libgalahad_all.bgo_reset_control(control::Ptr{bgo_control_type},
...
function bgo_solve_with_mat(data, userdata, status, n, x, g, ne, eval_f, eval_g, eval_h,
    ...
    @ccall libgalahad_all.bgo_solve_with_mat(data::Ptr{Ptr{Cvoid}}, userdata::Ptr{Cvoid},
...
function bgo_solve_without_mat(data, userdata, status, n, x, g, eval_f, eval_g, eval_hprod,
    ...
    @ccall libgalahad_all.bgo_solve_without_mat(data::Ptr{Ptr{Cvoid}}, userdata::Ptr{Cvoid},
...
function bgo_solve_reverse_with_mat(data, status, eval_status, n, x, f, g, ne, H_val, u, v)
    @ccall libgalahad_all.bgo_solve_reverse_with_mat(data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Cint},
...
function bgo_solve_reverse_without_mat(data, status, eval_status, n, x, f, g, u, v,
    ...
    @ccall libgalahad_all.bgo_solve_reverse_without_mat(data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Cint},
                                                        eval_status::Ptr{Cint}, n::Cint,
                                                        x::Ptr{Float64}, f::Float64,
...
function bgo_information(data, inform, status)
    @ccall libgalahad_all.bgo_information(data::Ptr{Ptr{Cvoid}},
                                          inform::Ptr{bgo_inform_type},
                                          status::Ptr{Cint})::Cvoid
end

function bgo_terminate(data, control, inform)
    @ccall libgalahad_all.bgo_terminate(data::Ptr{Ptr{Cvoid}},
                                        control::Ptr{bgo_control_type},
