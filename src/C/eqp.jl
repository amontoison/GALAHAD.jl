...
function eqp_initialize(data, control, status)
    @ccall libgalahad_all.eqp_initialize(data::Ptr{Ptr{Cvoid}},
                                         control::Ptr{eqp_control_type},
                                         status::Ptr{Cint})::Cvoid
end

function eqp_read_specfile(control, specfile)
    @ccall libgalahad_all.eqp_read_specfile(control::Ptr{eqp_control_type},
                                            specfile::Ptr{Cchar})::Cvoid
end

function eqp_import(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
                    A_ne, A_row, A_col, A_ptr)
    @ccall libgalahad_all.eqp_import(control::Ptr{eqp_control_type}, data::Ptr{Ptr{Cvoid}},
...
function eqp_reset_control(control, data, status)
    @ccall libgalahad_all.eqp_reset_control(control::Ptr{eqp_control_type},
                                            data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint})::Cvoid
end

function eqp_solve_qp(data, status, n, m, h_ne, H_val, g, f, a_ne, A_val, c, x, y)
    @ccall libgalahad_all.eqp_solve_qp(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint}, n::Cint,
...
function eqp_solve_sldqp(data, status, n, m, w, x0, g, f, a_ne, A_val, c, x, y)
    @ccall libgalahad_all.eqp_solve_sldqp(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint}, n::Cint,
...
function eqp_resolve_qp(data, status, n, m, g, f, c, x, y)
    @ccall libgalahad_all.eqp_resolve_qp(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint}, n::Cint,
...
function eqp_information(data, inform, status)
    @ccall libgalahad_all.eqp_information(data::Ptr{Ptr{Cvoid}},
                                          inform::Ptr{eqp_inform_type},
                                          status::Ptr{Cint})::Cvoid
end

function eqp_terminate(data, control, inform)
    @ccall libgalahad_all.eqp_terminate(data::Ptr{Ptr{Cvoid}},
                                        control::Ptr{eqp_control_type},
