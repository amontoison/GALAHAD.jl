...
function tru_initialize(data, control, status)
    @ccall libgalahad_all.tru_initialize(data::Ptr{Ptr{Cvoid}},
                                         control::Ptr{tru_control_type},
                                         status::Ptr{Cint})::Cvoid
end

function tru_read_specfile(control, specfile)
    @ccall libgalahad_all.tru_read_specfile(control::Ptr{tru_control_type},
                                            specfile::Ptr{Cchar})::Cvoid
end

function tru_import(control, data, status, n, H_type, ne, H_row, H_col, H_ptr)
    @ccall libgalahad_all.tru_import(control::Ptr{tru_control_type}, data::Ptr{Ptr{Cvoid}},
...
function tru_reset_control(control, data, status)
    @ccall libgalahad_all.tru_reset_control(control::Ptr{tru_control_type},
                                            data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint})::Cvoid
end

function tru_solve_with_mat(data, userdata, status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
    @ccall libgalahad_all.tru_solve_with_mat(data::Ptr{Ptr{Cvoid}}, userdata::Ptr{Cvoid},
...
function tru_solve_without_mat(data, userdata, status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_prec)
    @ccall libgalahad_all.tru_solve_without_mat(data::Ptr{Ptr{Cvoid}}, userdata::Ptr{Cvoid},
...
function tru_solve_reverse_with_mat(data, status, eval_status, n, x, f, g, ne, H_val, u, v)
    @ccall libgalahad_all.tru_solve_reverse_with_mat(data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Cint},
...
function tru_solve_reverse_without_mat(data, status, eval_status, n, x, f, g, u, v)
    @ccall libgalahad_all.tru_solve_reverse_without_mat(data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Cint},
                                                        eval_status::Ptr{Cint}, n::Cint,
                                                        x::Ptr{Float64}, f::Float64,
...
function tru_information(data, inform, status)
    @ccall libgalahad_all.tru_information(data::Ptr{Ptr{Cvoid}},
                                          inform::Ptr{tru_inform_type},
                                          status::Ptr{Cint})::Cvoid
end

function tru_terminate(data, control, inform)
    @ccall libgalahad_all.tru_terminate(data::Ptr{Ptr{Cvoid}},
                                        control::Ptr{tru_control_type},
