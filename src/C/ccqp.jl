...
function ccqp_initialize(data, control, status)
    @ccall libgalahad_all.ccqp_initialize(data::Ptr{Ptr{Cvoid}},
                                          control::Ptr{ccqp_control_type},
                                          status::Ptr{Cint})::Cvoid
end

function ccqp_read_specfile(control, specfile)
    @ccall libgalahad_all.ccqp_read_specfile(control::Ptr{ccqp_control_type},
                                             specfile::Ptr{Cchar})::Cvoid
end

function ccqp_import(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
                     A_ne, A_row, A_col, A_ptr)
    @ccall libgalahad_all.ccqp_import(control::Ptr{ccqp_control_type},
...
function ccqp_reset_control(control, data, status)
    @ccall libgalahad_all.ccqp_reset_control(control::Ptr{ccqp_control_type},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Cint})::Cvoid
end
...
function ccqp_solve_qp(data, status, n, m, h_ne, H_val, g, f, a_ne, A_val, c_l, c_u, x_l,
    ...
    @ccall libgalahad_all.ccqp_solve_qp(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint}, n::Cint,
...
function ccqp_solve_sldqp(data, status, n, m, w, x0, g, f, a_ne, A_val, c_l, c_u, x_l, x_u,
    ...
    @ccall libgalahad_all.ccqp_solve_sldqp(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
...
function ccqp_information(data, inform, status)
    @ccall libgalahad_all.ccqp_information(data::Ptr{Ptr{Cvoid}},
                                           inform::Ptr{ccqp_inform_type},
                                           status::Ptr{Cint})::Cvoid
end

function ccqp_terminate(data, control, inform)
    @ccall libgalahad_all.ccqp_terminate(data::Ptr{Ptr{Cvoid}},
                                         control::Ptr{ccqp_control_type},
