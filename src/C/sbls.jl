...
mutable struct sbls_inform_type
    ...
    sils_analyse_status::Cint
    sils_factorize_status::Cint
    sils_solve_status::Cint
    sls_analyse_status::Cint
    sls_factorize_status::Cint
    sls_solve_status::Cint
    uls_analyse_status::Cint
...
function sbls_initialize(data, control, status)
    @ccall libgalahad_all.sbls_initialize(data::Ptr{Ptr{Cvoid}},
                                          control::Ptr{sbls_control_type},
                                          status::Ptr{Cint})::Cvoid
end

function sbls_read_specfile(control, specfile)
    @ccall libgalahad_all.sbls_read_specfile(control::Ptr{sbls_control_type},
...
function sbls_import(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
    ...
    @ccall libgalahad_all.sbls_import(control::Ptr{sbls_control_type},
...
function sbls_reset_control(control, data, status)
    @ccall libgalahad_all.sbls_reset_control(control::Ptr{sbls_control_type},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Cint})::Cvoid
end

function sbls_factorize_matrix(data, status, n, h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
    @ccall libgalahad_all.sbls_factorize_matrix(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
...
function sbls_solve_system(data, status, n, m, sol)
    @ccall libgalahad_all.sbls_solve_system(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
                                            n::Cint, m::Cint, sol::Ptr{Float64})::Cvoid
end

function sbls_information(data, inform, status)
    @ccall libgalahad_all.sbls_information(data::Ptr{Ptr{Cvoid}},
                                           inform::Ptr{sbls_inform_type},
                                           status::Ptr{Cint})::Cvoid
end

function sbls_terminate(data, control, inform)
    @ccall libgalahad_all.sbls_terminate(data::Ptr{Ptr{Cvoid}},
                                         control::Ptr{sbls_control_type},
