...
function bqp_initialize(data, control, status)
    @ccall libgalahad_all.bqp_initialize(data::Ptr{Ptr{Cvoid}},
                                         control::Ptr{bqp_control_type},
                                         status::Ptr{Cint})::Cvoid
end

function bqp_read_specfile(control, specfile)
    @ccall libgalahad_all.bqp_read_specfile(control::Ptr{bqp_control_type},
                                            specfile::Ptr{Cchar})::Cvoid
end

function bqp_import(control, data, status, n, H_type, ne, H_row, H_col, H_ptr)
    @ccall libgalahad_all.bqp_import(control::Ptr{bqp_control_type}, data::Ptr{Ptr{Cvoid}},
...
function bqp_import_without_h(control, data, status, n)
    @ccall libgalahad_all.bqp_import_without_h(control::Ptr{bqp_control_type},
                                               data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
                                               n::Cint)::Cvoid
end

function bqp_reset_control(control, data, status)
    @ccall libgalahad_all.bqp_reset_control(control::Ptr{bqp_control_type},
                                            data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint})::Cvoid
end

function bqp_solve_given_h(data, status, n, h_ne, H_val, g, f, x_l, x_u, y, z, x_stat)
    @ccall libgalahad_all.bqp_solve_given_h(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
...
function bqp_solve_reverse_h_prod(data, status, n, g, f, x_l, x_u, y, z, x_stat, v, prod,
                                  nz_v, nz_v_start, nz_v_end, nz_prod, nz_prod_end)
    @ccall libgalahad_all.bqp_solve_reverse_h_prod(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
                                                   n::Cint, g::Ptr{Float64}, f::Float64,
                                                   x_l::Ptr{Float64}, x_u::Ptr{Float64},
                                                   y::Ptr{Float64}, z::Ptr{Float64},
...
function bqp_information(data, inform, status)
    @ccall libgalahad_all.bqp_information(data::Ptr{Ptr{Cvoid}},
                                          inform::Ptr{bqp_inform_type},
                                          status::Ptr{Cint})::Cvoid
end

function bqp_terminate(data, control, inform)
    @ccall libgalahad_all.bqp_terminate(data::Ptr{Ptr{Cvoid}},
                                        control::Ptr{bqp_control_type},
